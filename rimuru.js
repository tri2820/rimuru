...
var real__ma_device_process_pcm_frames_capture__webaudio = asm["_ma_device_process_pcm_frames_capture__webaudio"]; asm["_ma_device_process_pcm_frames_capture__webaudio"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__ma_device_process_pcm_frames_capture__webaudio.apply(null, arguments);
};

var real__ma_device_process_pcm_frames_playback__webaudio = asm["_ma_device_process_pcm_frames_playback__webaudio"]; asm["_ma_device_process_pcm_frames_playback__webaudio"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__ma_device_process_pcm_frames_playback__webaudio.apply(null, arguments);
};
